...
public class TraditionalIsoReader {
    private final RandomAccessDataIF isoFile;
    ...
    public TraditionalIsoReader(RandomAccessDataIF isoFile) {
    ...
    public final IsoFormatInternalDataFile[] getInternalDataFiles(
            RandomAccessDataIF file, long logicalSector, long size, String parent) throws IOException {
    ...
    public final IsoFormatDirectoryRecord[] getIsoDirectoryRecords(long logSect, long length, String parent)
        ...
        try (RandomAccessDataIF file = this.isoFile.copy()) {
    ...
    private IsoFormatDirectoryRecord[] getRecordsAtSector(
            RandomAccessDataIF file, long logSector, String parent, int loop) throws IOException {
        long seekLocation =
